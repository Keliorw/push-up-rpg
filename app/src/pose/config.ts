export interface DetectorConfig {
  ...
  /**
   * Упор лёжа = ноги ДАЛЬШЕ всего от камеры и ЗА туловищем. С пола (голова у
   * камеры) это значит: колени выше в кадре (меньше y), чем плечи, минимум на
   * столько долей длины торса. При вставании колени уходят вперёд-вниз (ближе к
   * камере), отношение падает — гейт отваливается, и подъём не считается за
   * повтор. Дополнительно требуется таз не ниже плеч (тоже «за туловищем»).
   */
