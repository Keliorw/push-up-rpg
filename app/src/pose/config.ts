export interface DetectorConfig {
  ...
  /**
   * Максимальное отношение высота/ширина рамки тела для планки. С камеры на
   * полу стоящий человек (ракурс снизу, укорочён) даёт ~2.3, а настоящая планка
   * ~1.5–1.7 (ближняя рука/плечи у камеры делают рамку шире). Порог 2.0 отсекает
   * наклоны стоя. Запас небольшой — при необходимости калибруется по «формат
   * тела» в web-demo. Надёжный античит на одной 2D-камере в принципе ограничен.
   */
