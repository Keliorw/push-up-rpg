...
## Решения
- **Вид кнопки:** круглая иконка 🏆, 56×56, тёмный полупрозрачный круг
  `rgba(11,17,31,.85)` с рамкой — зеркально существующей кнопке «назад»
  (`#map-back`) слева. Без новых ассетов.
